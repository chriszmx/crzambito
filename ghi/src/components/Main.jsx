...
const Main = () => {
    return (
        <div id="main" className="flex items-center justify-center bg-fixed bg-cover h-screen"
            ...
            <div className="p-10 bg-white/70 rounded-lg shadow-xl w-5/6 md:w-1/2 lg:w-1/3">
                ...
                <div className="flex justify-between pt-6 mb-4 max-w-[200px] w-full">
                ...
                <button className="py-2 px-4 mt-4 bg-blue-600 text-white rounded-lg focus:outline-none focus:shadow-outline">
                    <a href="mailto:c.r.zambito@gmail.com" className="text-white">Contact Me</a>
                </button>
            </div>
        </div>
    );
